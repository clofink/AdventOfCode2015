function day13Solution2(data) {
    ...
    for (let person in seatingPreferences) {
        if (!seatingPreferences['Me']) {
            seatingPreferences['Me'] = {};
        }
        seatingPreferences['Me'][person] = 0;
        seatingPreferences[person]['Me'] = 0;
    }

    let seatingCharts = permutator(Object.keys(seatingPreferences));
    let seatingScores = [];
    ...
    for (let seating of permutator(Object.keys(seatingPreferences))) {
        ...
        seatingScores.push(happiness);
    }

    seatingScores.sort(function(a,b) {
        return b - a;
    });
    return seatingScores[0]
